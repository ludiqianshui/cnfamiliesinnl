	...
	array(
		...
		'content' => '<p>' . __( 'This screen contains the settings that affect the display of your content.' ) . '</p>' .
			...
			'<p>' . sprintf(
				...
				__( 'You can also control the display of your content in RSS feeds, including the maximum number of posts to display and whether to show full text or a summary. <a href="%s">查看更多 about feeds</a>.' ),
...
<td><fieldset><legend class="screen-reader-text"><span><?php _e( 'For each post in a feed, include' ); ?> </span></legend>
	...
	<p class="description">
		...
		printf(
			/* translators: %s: Documentation URL. */
			__( 'Your theme determines how content is displayed in browsers. <a href="%s">查看更多 about feeds</a>.' ),
			__( 'https://wordpress.org/support/article/wordpress-feeds/' )
		);
		?>
	</p>
