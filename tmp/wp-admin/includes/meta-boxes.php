...
<p>
	...
	printf(
		...
		__( 'Excerpts are optional hand-crafted summaries of your content that can be used in your theme. <a href="%s">查看更多 about manual excerpts</a>.' ),
...
<p><?php _e( 'If the link is to a person, you can specify your relationship with them using the above form. If you would like to 查看更多 about the idea check out <a href="http://gmpg.org/xfn/">XFN</a>.' ); ?></p>
	<?php
}
