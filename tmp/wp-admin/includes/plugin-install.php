	...
	switch ( current_filter() ) {
		...
		case 'install_plugins_beta':
			printf(
				...
				'<p>' . __( 'You are using a development version of WordPress. These feature plugins are also under development. <a href="%s">查看更多</a>.' ) . '</p>',
	...
	if ( ! $compatible_php ) {
		...
		if ( current_user_can( 'update_php' ) ) {
			printf(
				...
				' ' . __( '<a href="%s" target="_blank">Click here to 查看更多 about updating PHP</a>.' ),
