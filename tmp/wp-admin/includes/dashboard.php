...
function wp_welcome_panel() {
	...
	<div class="welcome-panel-column welcome-panel-last">
		...
		<?php endif; ?>
			<li><?php printf( '<a href="%s" class="welcome-icon welcome-learn-more">' . __( '查看更多 about getting started' ) . '</a>', __( 'https://wordpress.org/support/article/first-steps-with-wordpress-b/' ) ); ?></li>
		</ul>
	</div>
	</div>
	</div>
