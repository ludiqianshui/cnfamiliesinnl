		...
		<div class="column">
			...
			<p>
				...
				printf(
					...
					__( 'WordPress is created by a <a href="%1$s">worldwide team</a> of passionate individuals. <a href="%2$s">欢迎加入 in WordPress</a>.' ),
			...
			<p>
				...
				printf(
					...
					__( 'Want to see your name in lights on this page? <a href="%s">欢迎加入 in WordPress</a>.' ),
					__( 'https://make.wordpress.org/' )
				);
				?>
			</p>
