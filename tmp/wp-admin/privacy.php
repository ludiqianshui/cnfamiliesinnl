		...
		<div class="column">
			...
			<p>
				...
				printf(
					...
					__( 'We take privacy and transparency very seriously. To 查看更多 about what data we collect, and how we use it, please visit <a href="%s">WordPress.org/about/privacy</a>.' ),
